...
import { Eye, EyeOff, Copy, Save, Check, AlertCircle, CheckCircle } from "lucide-react"
      ...
      <div className="grid gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Configure your Late API settings for social media posting</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button variant="outline" size="icon" onClick={() => setShowLateKey(!showLateKey)}>
                  {showLateKey ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                </Button>
                <Button
                  variant="outline"
                  size="icon"
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Default: https://api.getlate.dev (change only if using a different Late API endpoint)
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Configure OpenAI for AI-powered content generation</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  variant="outline"
                  size="icon"
                  onClick={() => copyToClipboard(openaiApiKey, "OpenAI API Key")}
        ...
        <div className="flex justify-end">
          <Button
            onClick={saveApiKeys}
            disabled={saving || (!lateApiKey && !lateProfileId && !openaiApiKey)}
