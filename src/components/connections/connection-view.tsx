...
const platformIcons = {
  ...
  Reddit: () => (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M14.5 3a1 1 0 0 0-1 1v2.126A7.94 7.94 0 0 0 12 6a7.999 7.999 0 1 0 7.62 5.5h.88a1.5 1.5 0 1 0-1.415-2H18a1 1 0 0 0-.894.553 6.006 6.006 0 0 0-3.606-1.68V4a1 1 0 0 0-1-1zM9 12.25a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5zm6 0a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5zM8.75 16.5a.75.75 0 0 1 .75.75c0 .966 1.79 1.75 4 1.75s4-.784 4-1.75a.75.75 0 0 1 1.5 0c0 1.83-2.686 3.25-5.5 3.25s-5.5-1.42-5.5-3.25a.75.75 0 0 1 .75-.75z" />
    </svg>
  ),
};
